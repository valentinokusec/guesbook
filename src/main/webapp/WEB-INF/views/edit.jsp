...
<div class="container-fluid">
    ...
    <c:forEach items="${userlist}" var="userlist">
				...
				<div class="form-group col-lg-12">
				 ...
				 <input name="username" type="text" class="form-control" value="${userlist.username}" />
					
				</div>
				<div class="form-group col-lg-12">
					<label>Lastname</label>
					
				 <input name="lastname" type="text" class="form-control" value="${userlist.lastname}" />
				 <input name="enabled" type="hidden"  value="1" />
					
				</div>
				<div class="form-group col-lg-6">
					<label>Password</label>
				 <input name="password" type="password"  class="form-control" value="${userlist.password}" />
				</div>
				...
				<div class="form-group col-lg-6">
				 ...
				 <input name="email" type="text"  class="form-control" value="${userlist.email}"/>
				</div>
				<div class="form-group col-lg-6">
					<label>Contact</label>
				 <input name="contact" type="text"  class="form-control" value="${userlist.contact}" />
				</div>
						<div class="form-group col-lg-6">
					<label>Adress</label>
				 <input name="adress" type="text"  class="form-control" value="${userlist.adress}"/>
				</div>
